...
import { resolveHomeDir } from "@jsext/fs/util/server";
import { interop } from "@jsext/module";
import { basename } from "@jsext/path";
import runtime, { env, platform } from "@jsext/runtime";
import { trimStart } from "@jsext/string";
import { isWSL, quote } from "./common.ts";
import { PowerShellCommands } from "./constants.ts";
 ...
 * @example
 * ```ts
 * import { powershell } from "@jsext/cli";
 * 
 * const cmd = "ls";
 * const {
 *     code,
