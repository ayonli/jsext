...
import { chunk as _chunk } from "@jsext/array/base";
import _bytes from "@jsext/bytes";
import { EMOJI_CHAR_RE } from "./constants.ts";
 ...
 * @example
 * ```ts
 * import { compare } from "@jsext/string";
 * 
 ...
 * @example
 * ```ts
 * import { random } from "@jsext/string";
 * 
 ...
 * @example
 * ```ts
 * import { count } from "@jsext/string";
 * 
 ...
 * @example
 * ```ts
 * import { hyphenate } from "@jsext/string";
 * 
 ...
 * @example
 * ```ts
 * import { words } from "@jsext/string";
 * 
 ...
 * @example
 * ```ts
 * import { chunk } from "@jsext/string";
 * 
 ...
 * @example
 * ```ts
 * import { truncate } from "@jsext/string";
 * 
 ...
 * @example
 * ```ts
 * import { trimEnd } from "@jsext/string";
 * 
 ...
 * @example
 * ```ts
 * import { trimStart } from "@jsext/string";
 * 
 ...
 * @example
 * ```ts
 * import { byteLength } from "@jsext/string";
 * 
...
export function isEmoji(str: string): boolean {
    return chars(str).every((char) => EMOJI_CHAR_RE!.test(char));
}
