 ...
 * @example
 * ```ts
 * import { AsyncFunction } from "@jsext/types";
 * 
 * async function foo() {
 *       // ...
 * }
 ...
 * @example
 * ```ts
 * import { GeneratorFunction } from "@jsext/types";
 * 
 * function* foo() {
 *     // ...
 * }
 ...
 * @example
 * ```ts
 * import { AsyncGeneratorFunction } from "@jsext/types";
 * 
 * async function* foo() {
 *    // ...
 * }
 ...
 * @example
 * ```ts
 * import { TypedArray } from "@jsext/types";
 * 
 ...
 * @example
 * ```ts
 * import { PartialKeys } from "@jsext/types";
 * 
 * interface User {
 *     name: string;
 *     age: number;
