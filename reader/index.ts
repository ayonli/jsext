 ...
 * @module
 */
import { concat as concatBytes, text } from "@jsext/bytes";
import {
    asAsyncIterable,
    toAsyncIterable,
    resolveByteStream,
 ...
 * @example
 * ```ts
 * import { readAsBlob } from "@jsext/reader";
 * import { createReadableStream } from "@jsext/fs";
 * 
 * const stream = createReadableStream("./package.json");
 ...
 * @example
 * ```ts
 * import { readAsDataURL } from "@jsext/reader";
 * 
 ...
 * @example
 * ```ts
 * import { readAsJSON } from "@jsext/reader";
 * import { createReadableStream } from "@jsext/fs";
 * 
 * const stream = createReadableStream("./package.json");
