...
import { AsyncTask, asyncTask } from "@jsext/async";
import { concat, text } from "@jsext/bytes";
import { createCloseEvent, createErrorEvent } from "@jsext/event";
import runtime from "@jsext/runtime";
import { ServerOptions, WebSocketConnection, WebSocketHandler, WebSocketLike } from "./base.ts";
import type { WebSocket, WebSocketStream } from "./client.ts";
import type { WebSocketServer as WsServer } from "ws";
import type { IncomingMessage } from "node:http";
import { NotSupportedError, throwUnsupportedRuntimeError } from "@jsext/error";
...
const noNodeJSSupportError = new NotSupportedError(
    "Node.js support is not implemented outside Node.js runtime.");
 ...
 * 
 * // Node.js (withWeb)
 * import { withWeb } from "@jsext/http";
...
export class WebSocketServer {
     ...
     * created using the `withWeb` function from `@jsext/http` module.
     * 
