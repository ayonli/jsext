...
import { isSubclassOf } from "@jsext/class";
import { random as rand } from "@jsext/number";
import {
    equals as _equals,
 ...
 * @example
 * ```ts
 * import { random } from "@jsext/array";
 * 
 * const arr = [1, 2, 3, 4, 5];
 * 
 ...
 * @example
 * ```ts
 * import { equals } from "@jsext/array";
 * 
 ...
 * @example
 * ```ts
 * import { includesSlice } from "@jsext/array";
 * 
 * const arr = [1, 2, 3, 4, 5];
 * 
 ...
 * @example
 * ```ts
 * import { startsWith } from "@jsext/array";
 * 
 * const arr = [1, 2, 3, 4, 5];
 * 
 ...
 * @example
 * ```ts
 * import { endsWith } from "@jsext/array";
 * 
 * const arr = [1, 2, 3, 4, 5];
 * 
 ...
 * @example
 * ```ts
 * import { unique } from "@jsext/array";
 * 
 * const arr = [1, 2, 3, 4, 5, 2, 3, 4, 2];
 * 
 ...
 * @example
 * ```ts
 * import { uniqueBy } from "@jsext/array";
 * 
 * const arr = [
 *     { id: 1, name: "foo" },
 *     { id: 2, name: "bar" },
 ...
 * @example
 * ```ts
 * import { shuffle } from "@jsext/array";
 * 
 * const arr = [1, 2, 3, 4, 5];
 * 
 ...
 * @example
 * ```ts
 * import { groupBy } from "@jsext/array";
 * 
 * const arr = [
 *     { id: 1, name: "foo" },
 *     { id: 2, name: "bar" },
 ...
 * @example
 * ```ts
 * import { partition } from "@jsext/array";
 * 
