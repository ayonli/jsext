...
import { Exception, throwUnsupportedRuntimeError } from "@jsext/error";
import { getMIME } from "@jsext/filetype";
import { as } from "@jsext/object";
import { basename, extname, join } from "@jsext/path";
import { readAsArray, readAsText, resolveByteStream } from "@jsext/reader";
import runtime, { platform } from "@jsext/runtime";
import { InvalidOperationError, NotDirectoryError } from "./errors.ts";
import type { FileInfo, DirEntry, FileSystemOptions, DirTree } from "./types.ts";
import { ensureFsTarget, fixDirEntry, makeTree, rawOp, wrapFsError } from "./util/index.ts";
import { resolveHomeDir } from "./util/server.ts";
import {
    getDirHandle,
    getFileHandle,
    stat as webStat,
 ...
 * ```ts
 * // with the default storage
 * import { ensureDir } from "@jsext/fs";
 * 
 ...
 * ```ts
 * // with the default storage
 * import { readFileAsText } from "@jsext/fs";
 * 
 ...
 * ```ts
 * // with the default storage
 * import { readFileAsFile } from "@jsext/fs";
 * 
 ...
 * ```ts
 * // with the default storage
 * import { writeFile } from "@jsext/fs";
 * 
 ...
 * ```ts
 * // with the default storage
 * import { writeLines } from "@jsext/fs";
 * 
 ...
 * ```ts
 * // with the default storage
 * import { stat, truncate } from "@jsext/fs";
 * 
 ...
 * import { copy, exists } from "@jsext/fs";
 * 
 ...
 * import { copy, getFileHandle } from "@jsext/fs";
 * 
 ...
 * import { copy, getDirHandle } from "@jsext/fs";
 * 
 ...
 * ```ts
 * // with the default storage
 * import { createWritableStream } from "@jsext/fs";
 * 
