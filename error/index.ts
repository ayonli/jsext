...
import { createErrorEvent } from "@jsext/event";
import { isPlainObject, omit } from "@jsext/object";
import { Constructor } from "@jsext/types";
import Exception, { type ExceptionOptions } from "./Exception.ts";
 ...
 * @example
 * ```ts
 * import { toObject } from "@jsext/error";
 * 
 ...
 * @example
 * ```ts
 * import { fromObject } from "@jsext/error";
 * 
 * const obj = {
 *     "@@type": "Error",
 *     name: "Error",
 ...
 * @example
 * ```ts
 * import { toErrorEvent } from "@jsext/error";
 * 
 * const err = new Error("Something went wrong.");
 * 
 ...
 * @example
 * ```ts
 * import { isCausedBy } from "@jsext/error";
 * 
