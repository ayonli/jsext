...
import {
    ...
    split as _split,
    chunk as _chunk,
} from "@jsext/array/base";
import { decodeBase64, decodeHex, encodeBase64, encodeHex } from "@jsext/encoding";
 ...
 * @example
 * ```ts
 * import { concat } from "@jsext/bytes";
 * 
 ...
 * @example
 * ```ts
 * import { compare } from "@jsext/bytes";
 * 
 * const arr1 = new Uint8Array([1, 2, 3]);
 ...
 * @example
 * ```ts
 * import { equals } from "@jsext/bytes";
 * 
 * const arr1 = new Uint8Array([1, 2, 3]);
 ...
 * @example
 * ```ts
 * import { includesSlice } from "@jsext/bytes";
 * 
 ...
 * @example
 * ```ts
 * import { indexOfSlice } from "@jsext/bytes";
 * 
 * const arr = new Uint8Array([1, 2, 3, 4, 5]);
 ...
 * @example
 * ```ts
 * import { startsWith } from "@jsext/bytes";
 * 
 * const arr = new Uint8Array([1, 2, 3, 4, 5]);
 * 
 ...
 * @example
 * ```ts
 * import { endsWith } from "@jsext/bytes";
 * 
 * const arr = new Uint8Array([1, 2, 3, 4, 5]);
 * 
