...
import { Exception, TimeoutError } from "@jsext/error";
 ...
 * @example
 * ```ts
 * import { abortable, sleep } from "@jsext/async";
 * 
 ...
 * @example
 * ```ts
 * import { timeout, sleep } from "@jsext/async";
 * 
 * const task = sleep(1000);
 * 
 ...
 * ```ts
 * // fetch example
 * import { select } from "@jsext/async";
 * 
 ...
 * @example
 * ```ts
 * import { abortWith } from "@jsext/async";
 * 
