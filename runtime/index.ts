...
import { parseUserAgent } from "@jsext/http/user-agent";
...
export interface RuntimeInfo {
     ...
     * use the `@jsext/fs` module to access the file system.
     */
    fsSupport: boolean;
    /**
 ...
 * @example
 * ```ts
 * import { addShutdownListener } from "@jsext/runtime";
 ...
 * @example
 * ```ts
 * import { addUnhandledRejectionListener } from "@jsext/runtime";
 * 
