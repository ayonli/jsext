...
import { stripEnd, trim } from "@jsext/string";
import {
    contains,
    endsWith,
    equals,
 ...
 * @example
 * ```ts
 * import { sanitize } from "@jsext/path";
 * 
 ...
 * @example
 * ```ts
 * import { dirname } from "@jsext/path";
 * 
 ...
 * @example
 * ```ts
 * import { toFileUrl } from "@jsext/path";
 * 
 ...
 * @example
 * ```ts
 * import { toFsPath } from "@jsext/path";
 * 
