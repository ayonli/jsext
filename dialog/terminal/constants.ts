...
export const UTIMap: { [id: string]: string[]; } = {
    ...
    "org.gnu.gnu-bzip2-archive": [".bz2", "application/x-bzip2"],
    ...
    "public.x-x509-ca-cert": [".pem", "application/x-x509-ca-cert"],
    ...
    "public.rar-archive": [".rar", "application/x-rar-compressed"],
    "public.rpm-archive": [".rpm", "application/x-rpm"],
    "public.deb-archive": [".deb", "application/x-deb"],
