...
const isTsx = isNode && ((_b = process.env["npm_lifecycle_script"]) === null || _b === void 0 ? void 0 : _b.match(/\btsx\b/)) ? true : false;
const IsPath = /^(\.[\/\\]|\.\.[\/\\]|[a-zA-Z]:|\/)/;
...
export { IsPath, handleChannelMessage, isBeforeNode14, isBun, isChannelMessage, isDeno, isMainThread, isNode, isTsx, resolveModule, unwrapChannel, wrapChannel };
