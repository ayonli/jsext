...
import { isBun, isDeno, isNode, isNodeLike } from "@jsext/env";
import { throwUnsupportedRuntimeError } from "@jsext/error";
import { ToDict } from "@jsext/types";
import {
    NetAddress,
    SocketStream,
    TcpConnectOptions,
...
import { getInternetIp } from "./util.ts";
 ...
 * @example
 * ```ts
 * import { udpSocket } from "@jsext/net";
 * 
